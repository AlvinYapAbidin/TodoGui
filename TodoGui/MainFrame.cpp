// Credit goes to OttoBotCode for the tutorial, thank you for helping me learn C++
...
void MainFrame::CreateControls()
{
	...
	wxFont headlineFont(wxFontInfo(wxSize(0, 37)).Bold());
	// Font for other controls
...
void MainFrame::OnListKeyDown(wxKeyEvent& evt)
{
	...
	{
	case WXK_DELETE: // chosen button to remove task
		DeleteSelectedTask();
		break;
	case WXK_HOME: // chosen button to remove task
		DeleteSelectedTask();
		break;
	case WXK_UP:
		MoveSelectedTask(-1);
...
void MainFrame::SwapTasks(int i, int j) // swaps the text and checkbox status at indices i and j
{
